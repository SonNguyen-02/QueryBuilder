...
public interface Join<T> {
     ...
     * -VD:
     * <br/>&nbsp;&nbsp; db.join("comments", "comments.id = student.id").
     * <br/>
     * -Produces:
     * <br/>&nbsp;&nbsp; JOIN comments ON comments.id = student.id.
     *
     ...
     * Generates the JOIN portion of the query.<br/>
     * -VD:
     * <br/>&nbsp;&nbsp; join("comments", "comments.id = student.id", JoinType.LEFT).
     * <br/>
     * -Produces:
     * <br/>&nbsp;&nbsp; LEFT JOIN comments ON comments.id = student.id.
     *
     * @param table Table name
     * @param cond  Condition
     * @param type  type
